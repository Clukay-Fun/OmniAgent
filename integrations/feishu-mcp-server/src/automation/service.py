...
from src.automation.cron_store import (
...
class AutomationService:
    ...
    def __init__(self, settings: Settings, client: Any) -> None:
        ...
        cron_queue_file = Path(str(settings.automation.cron_queue_file or "").strip() or "cron_queue.jsonl")
        if not cron_queue_file.is_absolute():
            cron_queue_file = Path.cwd() / cron_queue_file
        self._cron_store = CronStore(cron_queue_file)
